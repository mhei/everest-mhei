...
#ifndef EVACHARGE_SEEVSE_HPP
#define EVACHARGE_SEEVSE_HPP
...
class EVAchargeSEEVSE : public Everest::ModuleBase {
public:
    EVAchargeSEEVSE() = delete;
    EVAchargeSEEVSE(const ModuleInfo& info, std::unique_ptr<evse_board_supportImplBase> p_evse_board_support,
                    Conf& config) :
