...
#ifndef KVS_KVS_IMPL_HPP
#define KVS_KVS_IMPL_HPP
...
public:
    kvsImpl() = delete;
    kvsImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<BaptismData>& mod, Conf& config) :
        kvsImplBase(ev, "kvs"), mod(mod), config(config){};
...
private:
    const Everest::PtrContainer<BaptismData>& mod;
    const Conf& config;
