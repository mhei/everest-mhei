...
public:
    ...
    auth_token_providerImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<StronglinkSL032TokenProvider>& mod,
                            Conf& config) :
...
private:
    const Everest::PtrContainer<StronglinkSL032TokenProvider>& mod;
    const Conf& config;
