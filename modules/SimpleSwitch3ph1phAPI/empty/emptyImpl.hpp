...
public:
    emptyImpl() = delete;
    emptyImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<SimpleSwitch3ph1phAPI>& mod, Conf& config) :
...
private:
    const Everest::PtrContainer<SimpleSwitch3ph1phAPI>& mod;
    const Conf& config;
